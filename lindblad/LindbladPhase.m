function RhoOut = LindbladPhase(RhoIn,t,phase)
%Kraus transformation for the Y-pauli channel, that simulates phase noise
%of the qubit.
...
for i=1:nqbits
    ...
    M1=kron(eye(2^(i-1)),kron(Y,eye(2^(nqbits-i))));
    c0=0.5*(1+exp(-phase*t));
    c1=0.5*(1-exp(-phase*t));
