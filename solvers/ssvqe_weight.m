...
for j=1:nstates
    ...
    pseudo_Potential(j)=(real(pseudo_Energy(j))+(Repulsion+Ionization_Energies)*ones(1,length(pseudo_Energy(j)))); %Calculating pseudo potential for j-th state
end
